...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <Grid templateColumns='1fr 4fr' templateRows='1fr' p={0} height='100vh'>
      ...
      >
        <Flex alignItems='flex-start' justifyContent='space-between' mb={20}>
          <NextLink href='/'>
            <Icon viewBox='0 0 100 125' boxSize={12} cursor='pointer'>
              <path
        ...
        <NextLink href='/sites'>
          <Flex alignItems='center' mb={20} cursor='pointer'>
            <LinkIcon href='/dashboard' mr={2} boxSize={6} />
            <Heading size='sm'>Sites</Heading>
          </Flex>
        </NextLink>
